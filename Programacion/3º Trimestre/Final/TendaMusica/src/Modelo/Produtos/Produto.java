...
public abstract class Produto {
     ...
     */
    public Produto(int idProduto, double prezo, int cantidadeEnStock, String descricion) throws Modelo.Excepcions.PrezoNegativo, Modelo.Excepcions.StockNegativo{
