...
-- Alteramos la tabla 
ALTER TABLE Ejemplo1 ADD nuevo2 int CONSTRAINT valores_validos CHECK (nuevo2 > 10);
...
ALTER TABLE Ejemplo1 ADD nuevo3 char(2) CONSTRAINT valor_no DEFAULT ('NO');
...
--Alteramos nuevamente la tabla
ALTER TABLE Ejemplo1 ADD nuevo4 char(4) CONSTRAINT valorno4 DEFAULT ('NO')
WITH
VALUES;
...
ALTER TABLE Ejemplo1 ADD nuevo1 tinyint;
...
ALTER TABLE Ejemplo1 ADD CONSTRAINT res1 CHECK (nuevo2 BETWEEN 1 AND 100);

--Añadimos una constraint a la columna "nuevo3"
ALTER TABLE Ejemplo1 ADD CONSTRAINT res2 CHECK (nuevo3 > 100);

-- ELIMINAMOS LAS CONSTRAINTS
--Definimos que la columna "nuevo2" es UNIQUE
ALTER TABLE Ejemplo1 ADD CONSTRAINT nuevo2_unique UNIQUE (nuevo2);
