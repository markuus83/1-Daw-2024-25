...
CREATE TABLE TCENTR (
	...
	NOMCE VARCHAR(30) UNIQUE,
	SEÑAS VARCHAR(30) NOT NULL
...
ALTER TABLE TDEPTO
    ADD CONSTRAINT FK_TDEPTO_TCENTER FOREIGN KEY (NUMCE) REFERENCES TCENTR(NUMCE);

ALTER TABLE TEMPLE
    ADD CONSTRAINT FK_TEMPLE_TDEPTO FOREIGN KEY (NUMDE) REFERENCES TDEPTO(NUMDE);

ALTER TABLE TEMPLE
    ADD CONSTRAINT CK_TEMPLE_NUMHI CHECK (NUMHI BETWEEN 0 AND 9);
    
ALTER TABLE TEMPLE
    ADD CONSTRAINT CK_TEMPLE_SALAR CHECK (SALAR BETWEEN 0 AND 999);
