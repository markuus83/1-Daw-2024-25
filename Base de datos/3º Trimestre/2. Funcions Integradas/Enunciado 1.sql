...
DROP DATABASE IF EXISTS ALMACEN_25;
GO
CREATE DATABASE ALMACEN_25;
GO
USE ALMACEN_25;
...
/******* Más ejemplos de FI y actualizaci�n de datos ****************/
    
-- Mostrar los a�os que lleva de antiguedad un empleado

 
-- A�adir 0.2 de comisi�n a los empleados tengan una comisi�n menor de 0.5 o no tienen


-- Obtener el n�mero, nombre y l�mite cr�dito de los clientes con cr�dito inferior a la media de los cr�ditos.


-- Para la tabla de empleados, a�adir una columna email a los empleados en la que se almacene un email creado 
 --uniendo el nombre y el apellidos separado por - y concatenando el dominio '@mialmacen.com'


	--SOLUCION1: Sin tener en cuenta el orden nombre y apellido


	--SOLUCION2: Cambiando el orden nombre primero: nombre-apellido@mialmacen.com
	--Primero comprobamos el resultado antes de hacer el update


	-- Ejecutamos el cambio.
 

-- En la tabla empleados crear las columnas necesarias para separar nombre y apellido de cada uno.
 
	--SOLUCION1: -- Creando una nueva columna para nombre

	-- SOLUCION2: Modificando la columna existente