...
CREATE TABLE PROXECTO (
	...
	CONSTRAINT PK_PROXECTO PRIMARY KEY (Cod_Proxect, Cod_Aplic),
...
CREATE TABLE TRABALLA (
	...
	Cod_Aplic TINYINT,
	Cod_Proxecto TINYINT,
	DNI VARCHAR(9),
	
	CONSTRAINT PK_TRABALLA PRIMARY KEY (Cod_Aplic, Cod_Proxecto, DNI),

	-- HACER LAS FOREIGN KEY --
	CONSTRAINT
	CONSTRAINT
	CONSTRAINT
);
